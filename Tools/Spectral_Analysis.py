...
# def Power_calculation(Epoch_compute,frequency_band):
#     power_left = mne.time_frequency.tfr_morlet(Epoch_compute, n_cycles=2, return_itc=False,freqs=frequency_band, decim=3,average = False)
#     power_left.apply_baseline(mode='ratio', baseline=(None, 0))
#     epochs_power_1 = power_left.data
#     print(epochs_power_1.shape)
#     return epochs_power_1
# def Power_fft_calculation(Epoch_compute):
#     sampling_rate = nfft_test
#     fourier_transform = fft.fft(Epoch_compute,n=nfft_test)
#     # print(fourier_transform.shape)
#     #f,fourier_transform = signal.periodogram(Epoch_compute,fs=sampling_rate,nfft = nfft_test)
#     #print(fourier_transform.shape)
#
#     return np.square(abs(fourier_transform))
