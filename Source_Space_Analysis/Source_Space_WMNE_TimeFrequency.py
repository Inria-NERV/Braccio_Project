...
"""Dialog-Style application."""
from mne.minimum_norm import make_inverse_operator, apply_inverse,source_induced_power
...
def launch(path,filename_1,filename_2,filename_3,filename_4,filename_5,filename_6,filename_7,filename_8,cond1,cond2,tmin,tmax,nfft,noverlap,nper_seg,fs,filter_order,number_electrodes,car_bool,strat,name_sub,path_to_save):
    ...
    freqs = np.arange(4, 35, 2)  # define frequencies of interest
    parc = "aparc"
    ...
    PSD_Rest_Test_all = []
    PSD_Rest_Test_2_all = []
    for k in range(len(labels_parc)):
        if labels_parc[k].name in Actual_connections:
            print("Hello")
            power_mi, itc_mi = source_induced_power(
                epochs_MI,
                inverse_operator,
                freqs,
                labels_parc[k],
            ...
            print("Done 1")
            power_rest, itc_rest = source_induced_power(
                epochs_Rest,
                inverse_operator,
                freqs,
                labels_parc[k],
            ...
            print("Done 2")
            power_mi_test, itc_mi_test = source_induced_power(
                epochs_MI_Test,
                inverse_operator_Test,
                freqs,
                labels_parc[k],
                baseline=None,
                n_cycles=n_cycles,
            ...
            print("Done 3")
            power_rest_test, itc_rest_test = source_induced_power(
                epochs_Rest_Test,
                inverse_operator_Test,
                freqs,
                labels_parc[k],
            ...
            print("Done 4")
            power_mi_test_2, itc_mi_test_2 = source_induced_power(
                epochs_MI_Test_2,
                inverse_operator_Test_2,
                freqs,
                labels_parc[k],
                baseline=None,
                n_cycles=n_cycles,
            ...
            print("Done 5")
            power_rest_test_2, itc_rest_test_2 = source_induced_power(
                epochs_Rest_Test_2,
                inverse_operator_Test_2,
                freqs,
                labels_parc[k],
            ...
            print("Done 6")
            PSD_MI_Cali_all.append(power_mi.mean(0))
            PSD_MI_Test_all.append(power_mi_test.mean(0))
            PSD_MI_Test_2_all.append(power_mi_test_2.mean(0))

            PSD_Rest_Cali_all.append(power_rest.mean(0))
            PSD_Rest_Test_all.append(power_rest_test.mean(0))
            PSD_Rest_Test_2_all.append(power_rest_test_2.mean(0))
            print("Done 7")
    PSD_MI_Cali_all = np.array(PSD_MI_Cali_all)
    PSD_MI_Test_all = np.array(PSD_MI_Cali_all)
    PSD_MI_Test_2_all = np.array(PSD_MI_Test_2_all)

    PSD_Rest_Cali_all = np.array(PSD_Rest_Cali_all)
    PSD_Rest_Test_all = np.array(PSD_Rest_Test_all)
    PSD_Rest_Test_2_all = np.array(PSD_Rest_Test_2_all)

    np.save(path_to_save + name_sub + 'TF_M_Cali_Diff_source.npy',(PSD_MI_Cali_all-PSD_Rest_Cali_all)/PSD_Rest_Cali_all)
    np.save(path_to_save + name_sub + 'TF_M_Dr1_Diff_source.npy', (PSD_MI_Test_all - PSD_Rest_Test_all) / PSD_Rest_Test_all)
    np.save(path_to_save + name_sub + 'TF_M_Dr2_Diff_source.npy', (PSD_MI_Test_2_all - PSD_Rest_Test_2_all) / PSD_Rest_Test_2_all)
